...
export default function MonthlyAttendance() {
  ...
  const totalWorkingDays = totalDaysInMonth - officeOffDays.length;
  ...
  // ================= RENDER =================
  return (
    <div className="p-4 md:p-6 max-w-full mx-auto overflow-x-auto bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 rounded-3xl shadow-2xl animate-[fadeIn_0.6s_ease-out]">
        ...
        <div className="flex gap-2 items-start md:items-center">
          ...
          <div className="relative">
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transition-transform transform hover:scale-105"
            >
              Add Office Off
            </button>
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white ml-2 px-4 py-2 rounded-lg font-semibold shadow-md hover:shadow-lg transition-transform transform hover:scale-105"
            >
              Export to Excel
            </button>
